    ...
    <section className="bg-gradient-to-br from-green-50 to-blue-50 py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="shadow-2xl rounded-2xl bg-white transform -rotate-1">
            <CardContent className="p-8 md:p-12 relative text-center">
              ...
              <blockquote className="text-xl text-foreground font-medium italic relative z-10">
              ...
              <div className="mt-8 flex items-center justify-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-lg text-foreground">Ahmed Al Mansouri</p>
